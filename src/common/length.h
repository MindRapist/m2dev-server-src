...
enum EMisc2
{
	...
	DRAGON_SOUL_EQUIP_SLOT_END = DRAGON_SOUL_EQUIP_SLOT_START + (static_cast<uint8_t>(DS_SLOT_MAX) * static_cast<uint8_t>(DRAGON_SOUL_DECK_MAX_NUM)),
	DRAGON_SOUL_EQUIP_RESERVED_SLOT_END = DRAGON_SOUL_EQUIP_SLOT_END + (static_cast<uint8_t>(DS_SLOT_MAX) * static_cast<uint8_t>(DRAGON_SOUL_DECK_RESERVED_MAX_NUM)),
